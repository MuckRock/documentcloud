...
SOLR_REINDEX_LIMIT = env.int("SOLR_REINDEX_LIMIT", default=50)
SOLR_REINDEX_CATCHUP_SECONDS = env.int("SOLR_REINDEX_CATCHUP_SECONDS", default=300)
SOLR_REINDEX_MAX_SIZE = env.int("SOLR_REINDEX_MAX_SIZE", default=19 * 1024 * 1024)
