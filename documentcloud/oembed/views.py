...
class OEmbedView(APIView):
    ...
    example_oembed_response = {
        ...
        "width": 800,
        "height": 1035,
        "html": """<iframe src="https://embed.documentcloud.org/documents/25524482-the-mueller-report/?embed=1" title="the-mueller-report (Hosted by DocumentCloud)" width="800" height="1035" style="border: 1px solid #aaa; width: 100%; height: 800px; height: calc(100vh - 100px);" sandbox="allow-scripts allow-same-origin allow-popups allow-forms allow-popups-to-escape-sandbox"></iframe>""",
        "type": "rich",
    }

    @extend_schema(
        summary="oembed_retrieve",
        description="Retrieve an oEmbed response for embedding a document, page, or project.",
        parameters=[
            OpenApiParameter(
                name="url",
            ...
            200: OpenApiResponse(
                ...
                examples=[
                    OpenApiExample(
                        ...
                        description="An example oEmbed response for the Mueller Report.",
