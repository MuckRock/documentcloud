...
| original_extension  | String       | Default: `pdf`     | The original file extension of the document you are seeking to upload using upload(), if none is provided it is assumed to be a PDF.                             |
